...
### adding clusters:
[here](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/nrf/ug_zigbee_adding_clusters.html) is how you can add a new  cluster to the gateway the codes are:( make sure to add them in an appropriate place)
``` c
